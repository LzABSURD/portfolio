...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/luansalazar/",
        icon: Icons.linkedin,
  ...
  projects: [
    {
      title: "Figueirense",
      href: "https://github.com/LzABSURD/figueirense",
      dates: "Nov 2024 - Nov 2024",
      active: true,
      description:
        "O objetivo desse projeto foi aprimorar meus conhecimentos em HTML e CSS, criando uma página simples e eficaz, com um design intuitivo e responsivo. Foi uma excelente oportunidade para colocar em prática o que venho estudando, e o resultado ficou muito bacana!",
      technologies: [
        "HTML",
        "CSS",
      ],
      links: [
        {
          type: "Website",
          href: "https://figueirense-one.vercel.app/",
